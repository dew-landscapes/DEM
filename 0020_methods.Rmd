...
* aggregated or disaggregated to roughly `r settings$target_res` m from original resolution
* reprojected into the same `r terra::res(samples$ras2020[[1]])[1]` m raster
